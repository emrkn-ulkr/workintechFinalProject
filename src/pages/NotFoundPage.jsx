...
function NotFoundPage() {
  ...
  return (
    <section className="rounded-2xl bg-white p-8 text-center shadow-sm">
      ...
      <h1 className="mt-2 font-display text-3xl font-semibold text-ink-900">{t('notFoundPage.title')}</h1>
      <p className="mt-3 text-sm text-ink-600">{t('notFoundPage.description')}</p>
      <Link
        to="/"
