  ...
  return (
    <div className="flex flex-col gap-6 lg:flex-row">
      <section className="rounded-2xl bg-white p-6 shadow-sm lg:w-[56%]">
        <p className="text-xs font-semibold uppercase tracking-wide text-brand-600">{t('contactPage.label')}</p>
        <h1 className="mt-2 font-display text-3xl font-semibold text-ink-900">{t('contactPage.title')}</h1>
        <p className="mt-4 text-sm text-ink-600">{t('contactPage.description')}</p>
      ...
      <section className="rounded-2xl bg-white p-6 shadow-sm lg:w-[44%]">
        <h2 className="font-display text-xl font-semibold text-ink-900">{t('contactPage.contactInformation')}</h2>
